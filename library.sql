...
CREATE TABLE `book` (
  ...
  `book_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '书籍书名',
  `author_id` int NOT NULL COMMENT '书籍作者id',
  `IBSN` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'IBSN_is_not_exist' COMMENT '书籍IBSN号：默认为[IBSN_is_not_exist]',
  `publishing_company_id` int DEFAULT '12' COMMENT '书籍出版社id：id为12时代表无出版社，默认为12',
  `tag_id` int DEFAULT NULL COMMENT '书籍类型标签id',
  `quantity` int DEFAULT '1' COMMENT '书籍库存数量：默认为1',
  `price` int DEFAULT '0' COMMENT '书籍单价：单价为0时代表该书为公益书籍，默认为0',
  `is_being_borrowed` int NOT NULL DEFAULT '0' COMMENT '书籍是否外借标志：0为否、>=1为是，默认为0，当值大于库存数量时无法借出',
  `publication_date` date DEFAULT '1900-01-01' COMMENT '书籍出版日期：默认为''01-1月-1900''',
  `joint_author_table_id` int DEFAULT '0' COMMENT '书籍是否为共同创作标志：0为否、>=1则为共同作者表id号，默认为0',
...
CREATE TABLE `publishing_company` (
  ...
  `publishing_company_telephone_number` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'publishing_company_telephone_number_is_not_exist' COMMENT '出版社联系方式',
  `publishing_company_address` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'publishing_company_address_is_not_exist' COMMENT '出版社通信地址',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `is_deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除标志：0为未删除、1为已删除，默认为0',
...
INSERT INTO `publishing_company` VALUES (1,'人民出版社','13319210901','北京市东城区朝阳门内大街166号','2022-09-01 08:00:00',NULL,_binary '\0'),(2,'中华书局','13319120101','北京市丰台区太平桥西里38号','2022-09-01 08:00:00',NULL,_binary '\0'),(3,'人民文学出版社','13319510300','北京市东城区朝阳门内大街166号','2022-09-01 08:00:00',NULL,_binary '\0'),(4,'作家出版社','13319510000','北京市朝阳区农展馆南里10号办公楼11-13层','2022-09-01 08:00:00',NULL,_binary '\0'),(5,'中信出版社','13319880000','北京市朝阳区惠新东街甲4号8-10层','2022-09-01 08:00:00',NULL,_binary '\0'),(6,'中央编译出版社','13319930900','北京市西单西斜街36号','2022-09-01 08:00:00',NULL,_binary '\0'),(7,'机械工业出版社','13319520000','北京市西城区百万庄大街22号院3号楼1-9层','2022-09-01 08:00:00',NULL,_binary '\0'),(8,'科学出版社','13319540800','北京市西城区西直门南大街16号','2022-09-01 08:00:00',NULL,_binary '\0'),(9,'清华大学出版社','13319800600','北京市海淀区清华大学学研大厦A座6层','2022-09-01 08:00:00',NULL,_binary '\0'),(10,'三联书店','13319481000','北京市美术馆东街22号','2022-09-01 08:00:00',NULL,_binary '\0'),(11,'商务印书馆','13318970211','北京市王府井大街36号','2022-09-01 08:00:00',NULL,_binary '\0'),(12,'702出版社','13320220511','羊城帝江区北荒学府岱宗区8栋702','2022-09-01 08:00:00',NULL,_binary '\0');
...
CREATE TABLE `joint_author_table` (
  `joint_author_table_id` int NOT NULL COMMENT '共同作者表id：>=1则代表存在共同作者',
  `table_id` int NOT NULL COMMENT '共同作者表实例id',
  `author_id` int NOT NULL COMMENT '共同作者表对应的作者id：相同table_id的作者为该joint_author_table_id对应的书的共同作者',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `is_deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除标志：0为未删除、1为已删除，默认为0',
...
CREATE TABLE `book_borrow_table` (
  ...
  `is_borrowing` int DEFAULT '1' COMMENT '书籍是否仍处于借用中标志：0为否、1为是，默认为1',
  `borrow_time` datetime DEFAULT '1900-01-01 08:00:00' COMMENT '书籍外借时间：默认为1900-01-01 08:00:00',
  `back_time` datetime DEFAULT NULL COMMENT '书籍归还时间：默认为null',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `is_deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除标志：0为未删除、1为已删除，默认为0',
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='借书表信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `book_borrow_table` VALUES (1,2,1,1,'2022-09-06 12:34:56',NULL,'2022-09-06 12:34:56',NULL,_binary '\0'),(2,1,2,1,'2022-09-11 11:11:11',NULL,'2022-09-11 11:11:11',NULL,_binary '\0'),(3,1,3,1,'2022-09-11 11:11:11',NULL,'2022-09-11 11:11:11',NULL,_binary '\0'),(4,3,2,0,'2022-09-11 11:11:11','2022-09-12 12:00:00','2022-09-11 11:11:11','2022-09-12 12:00:00',_binary '\0'),(5,4,3,1,'2022-09-11 11:11:11',NULL,'2022-09-11 11:11:11',NULL,_binary '\0'),(6,5,2,1,'2022-09-11 11:11:11',NULL,'2022-09-11 11:11:11',NULL,_binary '\0'),(7,5,3,1,'2022-09-11 11:11:11',NULL,'2022-09-11 11:11:11',NULL,_binary '\0'),(8,6,3,1,'2022-09-11 11:11:11',NULL,'2022-09-11 11:11:11',NULL,_binary '\0'),(9,7,3,1,'2022-09-11 11:11:11',NULL,'2022-09-11 11:11:11',NULL,_binary '\0'),(10,8,3,1,'2022-09-11 11:11:11',NULL,'2022-09-11 11:11:11',NULL,_binary '\0'),(11,9,3,1,'2022-09-11 11:11:11',NULL,'2022-09-11 11:11:11',NULL,_binary '\0'),(12,10,3,1,'2022-09-11 11:11:11',NULL,'2022-09-11 11:11:11',NULL,_binary '\0'),(13,11,3,1,'2022-09-11 11:11:11',NULL,'2022-09-11 11:11:11',NULL,_binary '\0'),(14,12,3,1,'2022-09-11 11:11:11',NULL,'2022-09-11 11:11:11',NULL,_binary '\0');
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='读者信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `reader` VALUES (1,'xuuuyeee',1,20,627,'2022-09-01 08:00:00',NULL,_binary '\0'),(2,'HasturKiki',1,20,628,'2022-09-01 08:00:00',NULL,_binary '\0'),(3,'HolmesZᯤ⁶ᴳ',1,20,629,'2022-09-01 08:00:00',NULL,_binary '\0'),(4,'いほう',1,20,630,'2022-09-01 08:00:00',NULL,_binary '\0'),(5,'reader5',0,18,500,'2022-09-01 08:00:00',NULL,_binary '\0'),(6,'reader6',2,18,0,'2022-09-01 08:00:00',NULL,_binary '\0'),(7,'reader7',1,7,70,'2022-09-06 08:00:00',NULL,_binary '\0'),(8,'reader8',2,8,80,'2022-09-06 08:00:00',NULL,_binary '\0'),(9,'reader9',0,9,90,'2022-09-06 08:00:00',NULL,_binary '\0'),(10,'reader10',1,10,100,'2022-09-06 08:00:00',NULL,_binary '\0'),(11,'reader11',0,11,110,'2022-09-06 08:00:00',NULL,_binary '\0'),(12,'reader12',2,12,120,'2022-09-06 08:00:00',NULL,_binary '\0');
...
-- Dump completed on 2022-09-06 16:56:25
